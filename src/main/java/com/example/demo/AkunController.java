...
public class AkunController {
	...
	@PostMapping("/foto")
	public boolean perbaharuiFotoProfil(@RequestParam("usermail") String email, @RequestParam("imageURL") String gambarUrl)throws Exception {
		System.out.println(email);
		akunRepo.updatePhotoProfile(email, gambarUrl);
		isSuccess=true;
		return isSuccess;
	}
